...
void KICK_BALL_R(void);
void KICK_BALL_L(void);
...
void ARM_BACK(int mod);			//팔 뒤로
void GO_RIGHT_5(void);
void GO_LEFT_5(void);
void GO_RIGHT_17(void);
void GO_LEFT_17(void);
void HEAD_4BLACK(void);
void G_TURN_RIGHT(void);
void G_TURN_LEFT(void);
void HEAD_4NORM(void);
void HEAD_4BLUE(void);
void GO_BACK(int cnt);
